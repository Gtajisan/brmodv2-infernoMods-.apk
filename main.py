...
class WiFiScanner:
    ...
    def prompt_network(self) -> str:
        ...
        banner = f"""════════════════════════════════════════════════════════
    {green}< FARHAN-Shot >{reset} {cyan}v2.0.2 Enhanced{reset}
    
    [ TOOL ] {yellow}Core Engine:{reset} OneShot 0.0.2 © 2017 rofl0r
    [ CODE ] {yellow}GitHub:{reset} github.com/Gtajisan
    [ AUTHOR ] FARHAN
════════════════════════════════════════════════════════
    {red}[!]{reset} WiFi Security Assessment Tool: {yellow}Use Ethically & Legally{reset}
════════════════════════════════════════════════════════"""
        print(banner)
